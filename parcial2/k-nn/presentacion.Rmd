...
## Analisis de los Datos
### Descripcion De Variables (ContinuaciÃ³n)
...
- viajes_al_aÃ±o: La cantidad de viajes que reliza al aÃ±o.
...
- destreza_fÃ?sica: Del 1 al 10, la destreza fisica que tiene el alumno segun el mismo.
...
```{r}
hist(alumnos$viajes_al_ano, xlab ="viajes al año",main = "viajes al año")
...
#60% para entrenar
alumnos_train <- alumnos_n[1:90,]
#30% para probar 
alumnos_test <- alumnos_n[91:148,]
dim(alumnos_train)
dim(alumnos_test)              

alumnos_train_labels <- alumnos[1:90,2]
alumnos_train_labels
alumnos_test_labels <- alumnos[91:148,2]
alumnos_test_labels
