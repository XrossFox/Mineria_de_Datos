...
Los estudientes en promedio piensa n que la importancia es de 5. Esta ligeramente sezgado a la izquierda, esta bastante balanceado. El primer cuartil abarca entre 3 y 4, el tercero entre 6 y 8. El limite superior es de 10 y el inferior es de 0.
```{r fig11, fig.height = 3.5, fig.width = 8}
...
Otra grafica interesante. En promedio, los alumnos juegan 1.1 horas de videojuegos, el primer percentil abarca 0, y el tercero comienza en 1. La mediana es de 0. El limite superior es de 2. Cualquiera encima de 2 horas es considerado un outlier.
...
alumnos_n = sapply(alumnos[3:25],normalize)
str(alumnos_n)
```
